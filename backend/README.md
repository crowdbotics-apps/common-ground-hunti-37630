...
## Project Structure
    ...
    ├── common_ground_hunti_37630  # Django project configurations
...
1. Clone this repo and `cd common_ground_hunti_37630`
...
2. Clone this repo and `cd common_ground_hunti_37630`
